...
import {  XMarkIcon, BookmarkIcon, ArrowUturnLeftIcon } from '@heroicons/vue/20/solid'
            ...
            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
              ...
              <DialogPanel
                ...
                <div class="flex justify-end gap-2 py-3 px-4 ">
                  ...
                  <button type="button"
                    class=" flex justify-center items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 relative "
                    @click="submit">
