    ...
    <div class="bg-white border rounded p-4 mb-3">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-2  gap-3 mb-3 ">
            <template v-for="attachment of post.attachments">
                ...
                <div class="group relative aspect-square bg-blue-100 flex  flex-col items-center justify-center text-gray-500 ">
                    <!-- Download -->
                    <button
                        class="w-8 h-8 opacity-0 group-hover:opacity-100 transition-all  flex  items-center justify-center text-white  bg-gray-700 rounded absolute right-2 top-2 cursor-pointer hover:bg-gray-800">
        ...
        <div class="flex gap-2">
            <button class="text-gray-800 flex gap-1 py-2 px-4 rounded-lg  items-center bg-gray-100 justify-center  flex-1 hover:bg-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
